...
public class DettagliBarActivity extends FragmentActivity {
	...
	private List<PoiBean> listaTuttiPdi = HomeActivity.getListaBar();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		inflate.inflateImageBar(nome, logo);
	...
	protected void aggiungiPreferito() {
		if (db.checkIfAlreadyExists(id)) {
			...
			List<PoiBean> listaPoiBar = HomeActivity.getListaBar();
			for (PoiBean pb : listaPoiBar)
