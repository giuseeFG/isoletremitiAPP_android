...
public class DettagliAttivitaVarieActivity extends FragmentActivity {
	...
	private List<PoiBean> listaTuttiPdi = HomeActivity.getListaAttivitaVarie();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//		LinearLayout layoutPadre = (LinearLayout)findViewById(R.id.layoutPadreBarAttivitaRistorante);
		...
		inflate.inflateImageAttivita(nome, logo);
	...
	protected void aggiungiPreferito() {
		if (db.checkIfAlreadyExists(id)) {
			...
			List<PoiBean> listaPoiBeanAtt = HomeActivity.getListaAttivitaVarie();
			for (PoiBean pb : listaPoiBeanAtt)
